...
function SuccessPage() {
  ...
  const { name, email, eventName, pdfUrl } = location.state || {};  // Use pdfUrl from backend
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-100 to-green-300 p-6">
      ...
      <div className="bg-white shadow-2xl rounded-xl p-8 text-center max-w-lg w-full">
        <h2 className="text-4xl font-extrabold text-green-700 mb-4">
          🎊 Registration Successful for <span className="text-blue-600">{eventName}</span>!
        </h2>
        ...
        <p className="text-gray-600 mt-2">
          A confirmation email with your ticket has been sent to <span className="font-semibold">{email || "your email"}</span>.
        </p>
        ...
        <div className="mt-6 flex justify-center">
          {pdfUrl ? (
            ...
            <p className="text-red-500 font-bold">PDF SENT TO YOUR MAIL</p>
          )}
        </div>
