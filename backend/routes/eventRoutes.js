...
const { createEvent, getEvents, getEventByDetails, EditEvents, UpdateEvents, saveRegistrationFields,getEventById, getRoleRegistrationsCount } = require("../controllers/eventController");
